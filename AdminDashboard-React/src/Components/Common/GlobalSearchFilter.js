...
const RankGlobalFilter = () => {
    const [rankLevel, setRankLevel] = useState([]);
    const [rankPoints, setRankPoints] = useState(null);

    function handleRankLevel(rankLevel) {
        setRankLevel(rankLevel);
    }

    function handleRankPoints(rankPoints) {
    ...
    const rankLevels = [
        {
            options: [
                { label: "Rank Level", value: "Rank Level" },
                { label: "All", value: "All" },
    ...
    const rankPointsOptions = [
        {
            options: [
                { label: "Select Points", value: "Select Points" },
                { label: "All", value: "All" },
    ...
    return (
        <React.Fragment>
            <Col sm={6} className="col-xxl-2">
                {/* <div>
                    Uncomment and configure Flatpickr if needed
                    <Flatpickr
                        className="form-control"
                        id="datepicker-publish-input"
                        placeholder="Select a date"
            ...
            <Col sm={4} className="col-xxl-2">
                {/* <div>
                    Uncomment and configure Select if you are using react-select
                    <Select
                        value={rankLevel}
                        onChange={(e) => {
                            handleRankLevel(e);
            ...
            <Col sm={4} className="col-xxl-2">
                {/* <div>
                    ...
                    <Select
                        ...
                        options={rankPointsOptions}
                        name="choices-points-default"
                        id="idRankPoints"
                    ></Select>
                </div> */}
            </Col>
