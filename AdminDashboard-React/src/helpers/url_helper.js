...
// Ecommerce
//Notification
export const GET_NOTIFICATIONS = "/apps/notification";
export const UPDATE_NOTIFICATION = "/apps/notification";
...
// Rank
export const GET_RANKS = "/apps/rank";
export const GET_RANK_BY_ID = "/apps/rank";
export const DELETE_RANK = "/apps/rank";
export const ADD_NEW_RANK = "/apps/rank";
export const UPDATE_RANK = "/apps/rank";
