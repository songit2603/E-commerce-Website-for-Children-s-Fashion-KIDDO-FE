...
document.title="Search Results | Kiddo - Trang quản trị ";
                            ...
                            <Card>
                                <CardHeader className="border-0">
                                    <Row className="justify-content-center mb-4">
                                        ...
                                        <Col lg={12}>
                                            <h5 className="fs-16 fw-semibold text-center mb-0">Hiển thị results for "<span className="text-primary fw-medium fst-italic">Admin Dashboard</span> "</h5>
                                        </Col>
                                    </Row>
                                ...
                                <CardBody className="p-4">
                                    <TabContent activeTab={activeTab} className="text-muted">
                                        <TabPane tabId="1">
                                            ...
                                            <div className="py-3">
                                                <h5 className="fs-13 mb-3 text-muted fst-italic">Hiển thị results Images</h5>
                                                <Row>
                                                    <Col xl={4} lg={10}>
                                                        <Row className="g-2">
                                                            <Col md={3} sm={6}>
