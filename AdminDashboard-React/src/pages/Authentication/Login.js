...
const Login = (props) => {
    ...
    useEffect(() => {
        if (user && user) {
            console.log(user);
            const updatedUserData = process.env.REACT_APP_DEFAULTAUTH === "firebase" ? user.data.user.email : user.data.user.email;
            setUserLogin({
    ...
    document.title = "Đăng nhập | Kiddo - Trang quản trị ";
    return (
        <React.Fragment>
                    ...
                    <Container>
                        ...
                        <Row className="justify-content-center">
                            <Col md={8} lg={6} xl={5}>
                                <Card className="mt-4">
                                    <CardBody className="p-4">
                                        <div className="text-center mt-2">
                                            <h5 className="text-primary">Chào mừng đến với Kiddo!</h5>
                                ...
                                <div className="mt-4 text-center">
                                    <p className="mb-0">Chưa có tài khoản? <Link to="/register" className="fw-semibold text-primary text-decoration-underline"> Đăng kí ngay </Link> </p>
                                </div>
