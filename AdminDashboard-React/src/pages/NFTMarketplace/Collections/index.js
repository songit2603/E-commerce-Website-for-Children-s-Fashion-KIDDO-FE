...
const Collections = () => {
    document.title = "Collections | Kiddo - Trang quản trị ";
    return (
        <React.Fragment>
            <div className="page-content">
                <Container fluid>
                    ...
                    <Row className="g-0 text-center text-sm-start align-items-center mb-4">
                        <Col sm={6}>
                            <div>
                                <p className="mb-sm-0 text-muted">Hiển thị <span className="fw-semibold">1</span> to <span className="fw-semibold">8</span> of <span className="fw-semibold text-decoration-underline">12</span> entries</p>
                            </div>
                        </Col>
