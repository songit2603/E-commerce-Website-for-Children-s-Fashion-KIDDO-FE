...
const FileManager = () => {
    document.title = "File Manager | Kiddo - Trang quản trị ";
                                ...
                                <div>
                                    ...
                                    <div className="align-items-center mt-2 row g-3 text-center text-sm-start">
                                        <div className="col-sm">
                                            <div className="text-muted">Hiển thị<span className="fw-semibold">4</span> trên <span className="fw-semibold">125</span> Kết quả
                                            </div>
                                        </div>
