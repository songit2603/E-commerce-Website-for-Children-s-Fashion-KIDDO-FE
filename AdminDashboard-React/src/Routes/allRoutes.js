...
import EcommerceRanks from "../pages/Ecommerce/EcommerceRanks/index";
import EcommerceVouchers from "../pages/Ecommerce/EcommerceVouchers/index";
import EcommerceAddVoucher from "../pages/Ecommerce/EcommerceVouchers/EcommerceAddVoucher";
import EcommercePromotions from "../pages/Ecommerce/EcommercePromotions/index";
import EcommerceAddPromotion from "../pages/Ecommerce/EcommercePromotions/EcommerceAddPromotion";
...
const authProtectedRoutes = [
  ...
  { path: "/apps-ecommerce-products", component: <EcommerceProducts usePageContentStyle={true} /> },
  ...
  { path: "/apps-ecommerce-promotions", component: <EcommercePromotions /> },
  { path: "/apps-ecommerce-ranks", component: <EcommerceRanks /> },
  { path: "/apps-ecommerce-vouchers", component: <EcommerceVouchers /> },
  { path: "/apps-ecommerce-add-promotion", component: <EcommerceAddPromotion /> },
  { path: "/apps-ecommerce-add-promotion/:_id", component: <EcommerceAddPromotion /> },
  { path: "/apps-ecommerce-add-voucher/", component: <EcommerceAddVoucher /> },
  { path: "/apps-ecommerce-add-voucher/:_id", component: <EcommerceAddVoucher /> },
...
const publicRoutes = [
  ...
  { path: "/auth-pass-change-basic/:_id", component: <BasicPasswCreate /> },
