...
class Content extends Component {
    ...
    render() {
        const paginationData = this.state.data.slice((this.state.activePage - 1) * this.state.itemPerpage, this.state.activePage * this.state.itemPerpage).map((item, i) => {
            return <div key={i} className="col-xl-2 col-lg-3 col-md-3 col-sm-6">
                    ...
                    <div className="hm-shop-filter py-3">
                        <div className="hm-filter">
                            <ul className="list-inline">
                                <li className="list-inline-item hm-filter-border"><Link to="/shop" className="filter active"><i className="fa fa-th-large" /></Link>
                                </li>
                                <li className="list-inline-item hm-filter-border"><Link to="/shop-list" className="filter"><i className="fa fa-list" /></Link>
                                </li>
                            </ul>
