...
//address
export const getAddressesByUserId = (userId) => api.get(url.GET_ADDRESSES_BY_USERID+"/"+userId);
export const addNewAddress = address => api.create(url.ADD_ADDRESS, address);
export const deleteAddress = address => api.delete(url.DELETE_ADDRESS+"/"+address.userId+"/"+ address.addressId );
export const updateAddress = address => api.update(url.UPDATE_ADDRESS + '/' + address._id, address);
...
// add Cart
export const addCheckVoucher = (voucher) => api.create(url.ADD_CHECK_VOUCHER,voucher);
export const addToCartVoucher = (voucher) => api.create(url.ADD_TO_CART_VOUCHER,voucher);
// get Customers
...
export const deletePromotion = promotion => api.delete(url.DELETE_PROMOTION + '/' + promotion);
...
// add ReplyReview by ReviewId
export const addNewReplyReviewByReviewId = reviewReply => api.create(url.ADD_NEW_REPLY_REVIEW+'/'+ reviewReply._id,reviewReply);
export const updateReplyReviewByReviewId = reviewReply => api.update(url.UPDATE_REPLY_REVIEW+'/update-reply/'+ reviewReply.reviewId,reviewReply);
export const deleteReplyReviewByReviewId = reviewReply => api.deleteWithBody(url.DELETE_REPLY_REVIEW+'/delete-reply/'+ reviewReply.reviewId,reviewReply);
